...
const cardPage = () => {
  ...
  <span className="font-semibold text-white text-center block pt-[10px] text-[16px]">Person</span>
  <p className="font-normal text-white text-center block pt-[3px] text-[12px]">Job Title</p>

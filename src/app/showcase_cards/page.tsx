...
async function mood() {
  if (e == 'HAPPY') {
    ...
    return (
      <Image
        src={'/slightly_frowning_face.png'}
        height={30}
        width={30}
        alt="emoji"
      />
    ...
    return (
      <Image
        src={'/pleading-face.1024x986.png'}
        height={30}
        width={30}
        alt="emoji"
      />
...
export default async function ShowCards() {
  return (
    <section>
          ...
          <div key={index} className="flip-card">
            <div className="flip-card-inner">
              <div className="flip-card-front">
                <p className="title"></p>
                <img
                  className="w-[18.75rem] h-[18.75rem] self-center rounded-xl"
                  src={e}
                  alt=""
                />
                <p className="text-2xl font-bold pt-4">White Tiger</p>
                <p className="text-1xl">The G.O.A.T</p>
                <div className="flex justify-center gap-3 pt-2 ">
                  <div className="emojis">{mood()}</div>
                </div>
              </div>
              <div className="flip-card-back text-[1.3rem] flex flex-col">
                <PawPrint className="flex self-center py-2 h-14" />
                <p className="py-2">
                  <b className="text-gray-600">Name: </b>White tiger
                </p>
                <p className="py-2">
                  <b className="text-gray-600">Height: </b>7ft
                </p>
                <p className="py-2">
                  <b className="text-gray-600">Weight: </b>91kg
                </p>
                <p className="py-2">
                  <b className="text-gray-600">Age: </b>9 years
                </p>
                <p className="py-2">
                  <b className="text-gray-600">DOB: </b>6ft 2021-03-09
                </p>
                <p className="py-2">
                  <b className="text-gray-600">Location: </b>Dumli Down, Purulia
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="flex justify-center">
        <button className="shadow__btn">Donate</button>
      </div>
    </section>
  )
}
